...
vim.g.rustaceanvim = {
    ...
    server = {
        ...
        on_attach = function(_, bufnr)
            ...
            end, { buffer = bufnr, desc = "[C]ode [D]ocs" })
            ...
            vim.api.nvim_set_keymap("n", "<leader>cu", ':lua require("crates").upgrade_all_crates()<CR>', {
                noremap = true,
                silent = true,
                desc = "[C]rates [U]rgrade",
            })
            vim.api.nvim_set_keymap("n", "<leader>cr", '<cmd>lua require("renamer").rename()<cr>', {
                noremap = true,
                silent = true,
                desc = "[C]ode [R]ename",
            })
